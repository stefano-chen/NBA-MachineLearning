...
def compare_techniques(data: pd.DataFrame):
    ...
    }, save_to_file=_save_to_file, load_from_file=_load_from_file))
    ...
    results.append(model(GaussianNB(), x_train, x_test, y_train, y_test, {}, save_to_file=_save_to_file,
    ...
    results.append(model(DummyClassifier(), x_train, x_test, y_train, y_test, {}, save_to_file=_save_to_file,
                         load_from_file=_load_from_file))
